...
defmodule Bson.Test do
  ...
  test "xdoc" do
    term = [
        ...
        c: [x: -1, y: 2.2001],
        d: [23, 45, 200],
        eeeeeeeee: Bson.Bin[subtype: Bson.Bin.subtyx(Binary), bin: <<200, 12, 240, 129, 100, 90, 56, 198, 34, 0, 0>>],
        f: Bson.Bin[subtype: Bson.Bin.subtyx(Function), bin: <<200, 12, 240, 129, 100, 90, 56, 198, 34, 0, 0>>],
        g: Bson.Bin[subtype: Bson.Bin.subtyx(UUID), bin: <<49, 0, 0, 0, 4, 66, 83, 79, 78, 0, 38, 0, 0, 0, 2, 48, 0, 8, 0, 0, 0, 97, 119, 101, 115, 111, 109, 101, 0, 1, 49, 0, 51, 51, 51, 51, 51, 51, 20, 64, 16, 50, 0, 194, 7, 0, 0, 0, 0>>],
        h: Bson.Bin[subtype: Bson.Bin.subtyx(MD5), bin: <<200, 12, 240, 129, 100, 90, 56, 198, 34, 0, 0>>],
        i: Bson.Bin[subtype: Bson.Bin.subtyx(User), bin: <<49, 0, 0, 0, 4, 66, 83, 79, 78, 0, 38, 0, 0, 0, 2, 48, 0, 8, 0, 0, 0, 97, 119, 101, 115, 111, 109, 101, 0, 1, 49, 0, 51, 51, 51, 51, 51, 51, 20, 64, 16, 50, 0, 194, 7, 0, 0, 0, 0>>],
